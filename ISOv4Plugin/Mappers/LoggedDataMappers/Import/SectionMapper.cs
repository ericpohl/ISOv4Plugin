...
namespace AgGateway.ADAPT.ISOv4Plugin.Mappers
{
    ...
    {
        List<DeviceElementUse> Map(ISOTime time, IEnumerable<ISOSpatialRow> isoRecords, int operationDataId, IEnumerable<string> isoDeviceElementIDs, ProductAllocations isoProductAllocations);
